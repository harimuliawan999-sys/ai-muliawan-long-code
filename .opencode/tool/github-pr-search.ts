...
import { tool } from "@aimuliawan/plugin"
...
This tool searches PRs in the harimuliawan999-sys/ai-muliawan-long-code repository and returns LLM-friendly results including:
- PR number and title
- Author
