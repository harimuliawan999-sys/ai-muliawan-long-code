...
# Do-Not-Translate Terms (AIMLC Docs)
...
AIMLC config
AIMLC Config
AIMLC TUI with the opencode theme
AIMLC Web - Active Session
AIMLC Web - New Session
AIMLC Web - See Servers
AIMLC Zen
AIMLC-Obsidian
...
## AIMLC CLI commands (as shown in docs)
...
harimuliawan999-sys/ai-muliawan-long-code
apps/opencode-agent
...
https://aimuliawan.dev/zen/v1/chat/completions
https://aimuliawan.dev/zen/v1/messages
https://aimuliawan.dev/zen/v1/models/gemini-3-flash
https://aimuliawan.dev/zen/v1/models/gemini-3-pro
https://aimuliawan.dev/zen/v1/responses
