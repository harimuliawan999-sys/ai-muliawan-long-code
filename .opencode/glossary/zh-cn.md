...
- PR #13942: https://github.com/harimuliawan999-sys/ai-muliawan-long-code/pull/13942

## Do Not Translate (Locale Additions)

- `AIMLC` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `AIMLC Zen`
- `AIMLC CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `AIMLC`
