...
- PR #15835: https://github.com/harimuliawan999-sys/ai-muliawan-long-code/pull/15835

## Do Not Translate (Locale Additions)

- `AIMLC` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `AIMLC` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `AIMLC` inside commands, URLs, package names, or code literals
