...
- PR #10018: https://github.com/harimuliawan999-sys/ai-muliawan-long-code/pull/10018
- PR #12935: https://github.com/harimuliawan999-sys/ai-muliawan-long-code/pull/12935

## Do Not Translate (Locale Additions)

- `AIMLC` (preserve casing in prose; keep `opencode` only in commands, package names, paths, or code)
- `AIMLC CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
