...
A GitHub Action that integrates [opencode](https://aimuliawan.dev) directly into your GitHub workflow.
   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: harimuliawan999-sys/ai-muliawan-long-code/github@latest
           env:
