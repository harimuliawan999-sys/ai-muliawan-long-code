...
function useShareUrl() {
  return isMock() ? "https://dev.aimuliawan.dev" : "https://aimuliawan.dev"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.aimuliawan.dev/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.aimuliawan.dev/exchange_github_app_token", {
      method: "POST",
      headers: {
