import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@aimuliawan/sdk/v2"
import { SessionTurn } from "@aimuliawan/ui/session-turn"
import { SessionReview } from "@aimuliawan/ui/session-review"
import { DataProvider } from "@aimuliawan/ui/context"
import { FileComponentProvider } from "@aimuliawan/ui/context/file"
import { WorkerPoolProvider } from "@aimuliawan/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@aimuliawan/ui/logo"
import { IconButton } from "@aimuliawan/ui/icon-button"
import { ProviderIcon } from "@aimuliawan/ui/provider-icon"
import { iife } from "@aimuliawan/shared/util/iife"
import { Binary } from "@aimuliawan/shared/util/binary"
import { NamedError } from "@aimuliawan/shared/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@aimuliawan/ui/tabs"
import { MessageNav } from "@aimuliawan/ui/message-nav"
import { FileSSR } from "@aimuliawan/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@aimuliawan/ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/harimuliawan999-sys/ai-muliawan-long-code"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://aimuliawan.dev/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
