...
O esquema de configuração do servidor/tempo de execução é definido em [**`aimuliawan.dev/config.json`**](https://aimuliawan.dev/config.json).

A configuração do TUI usa [**`aimuliawan.dev/tui.json`**](https://aimuliawan.dev/tui.json).
