...
Você também pode baixar o binário na seção [Releases](https://github.com/harimuliawan999-sys/ai-muliawan-long-code/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [AIMLC Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [aimuliawan.dev/auth](https://aimuliawan.dev/auth).
...
Aqui está uma [conversa de exemplo](https://aimuliawan.dev/s/4XP1fce5) com o opencode.
