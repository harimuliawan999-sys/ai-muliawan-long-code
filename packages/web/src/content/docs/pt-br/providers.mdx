...
AIMLC Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o AIMLC Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `AIMLC Zen` e acesse [aimuliawan.dev/zen](https://aimuliawan.dev/zen).
...
AIMLC Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `AIMLC Go` e acesse [aimuliawan.dev/zen](https://aimuliawan.dev/zen).
...
AIMLC Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>AIMLC Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **AIMLC Zen**.
