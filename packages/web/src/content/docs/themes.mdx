...
With AIMLC you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, AIMLC uses our own `opencode` theme.
...
AIMLC comes with several built-in themes.
...
- Want AIMLC to match their terminal's appearance
...
AIMLC supports a flexible JSON-based theme system that allows users to create and customize themes easily.
