---
title: خوادم LSP
description: يتكامل AIMLC مع خوادم LSP لديك.
---

يتكامل AIMLC مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي AIMLC مع عدة خوادم LSP مدمجة للغات الشائعة:
