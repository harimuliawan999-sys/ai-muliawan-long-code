...
Agent skills let AIMLC discover reusable instructions from your repo or home directory.
...
AIMLC searches these locations:
...
For project-local paths, AIMLC walks up from your current working directory until it reaches the git worktree.
...
AIMLC lists available skills in the `skill` tool description.
