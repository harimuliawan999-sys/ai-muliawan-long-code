---
title: Deling
description: Del dine AIMLC-samtaler.
---

AIMLCs delingsfunksjon lar deg lage offentlige lenker til dine AIMLC-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
AIMLC støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger AIMLC manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
