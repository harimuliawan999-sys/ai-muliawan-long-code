---
title: Plugins
description: Skriv dine egne plugins for at udvide AIMLC.
---

Plugins giver dig mulighed for at udvide AIMLC ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre AIMLCs standardadfærd.
...
AIMLC kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger AIMLC desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
...
Niveauer: `debug`, `info`, `warn`, `error`. Se [SDK documentation](https://aimuliawan.dev/docs/sdk) for detaljer.
