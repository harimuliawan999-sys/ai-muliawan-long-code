---
title: Zen
description: Udvalgt liste over modeller leveret af AIMLC.
---
...
AIMLC Zen er en liste over testede og verificerede modeller leveret af AIMLC-teamet.

:::note
AIMLC Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i AIMLC. Du logger ind på AIMLC Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med AIMLC.
:::
...
AIMLC Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

AIMLC Zen fungerer som enhver anden udbyder i AIMLC.

1. Du logger ind på **<a href={console}>AIMLC Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger AIMLC Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din AIMLC-konfiguration
...
- MiniMax M2.5 Free er tilgængelig på AIMLC i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo V2 Pro Free er tilgængelig på AIMLC i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo V2 Omni Free er tilgængelig på AIMLC i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på AIMLC i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på AIMLC i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med AIMLC også.
