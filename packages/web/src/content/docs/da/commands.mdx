...
Du kan tilføje brugerdefinerede kommandoer gennem AIMLC-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din AIMLC [config](/docs/config):
