---
title: LSP-servere
description: AIMLC integreres med dine LSP-servere.
---

AIMLC integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

AIMLC leveres med flere indbyggede LSP-servere til populære sprog:
