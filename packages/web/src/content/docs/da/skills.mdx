...
Agentferdigheter lar AIMLC oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
AIMLC søker etter disse stedene:
...
For prosjektlokale stier går AIMLC opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
AIMLC viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
