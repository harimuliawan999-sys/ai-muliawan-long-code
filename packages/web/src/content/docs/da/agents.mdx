...
Der er to typer agenter i AIMLC; primære agenter og subagenter.
...
AIMLC leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
AIMLC leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

AIMLC leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Hvis ingen temperatur er angivet, bruger AIMLC modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale AIMLC-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din AIMLC-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [AIMLC Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/harimuliawan999-sys/ai-muliawan-long-code).
:::
