...
Med AIMLC kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger AIMLC vårt eget `opencode`-tema.
...
AIMLC kommer med flere innebygde temaer.
...
- Vil at AIMLC skal matche terminalens utseende
...
AIMLC støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
