---
title: TUI
description: Using the AIMLC terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AIMLC provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running AIMLC starts the TUI for the current directory.
...
When using the AIMLC TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to AIMLC. Allows you to select from available providers and add their API keys.
