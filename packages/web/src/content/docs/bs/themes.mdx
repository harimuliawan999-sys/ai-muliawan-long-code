...
U AIMLC mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, AIMLC koristi nasu `opencode` temu.
...
AIMLC dolazi sa vise ugradenih tema.
...
- Zele da AIMLC odgovara izgledu njihovog terminala
...
AIMLC podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
