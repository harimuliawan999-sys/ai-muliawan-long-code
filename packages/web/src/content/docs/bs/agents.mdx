...
Postoje dvije vrste agenata u AIMLC: primarni agenti i podagenti.
...
AIMLC dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
AIMLC dolazi sa dva ugrađena subagenta, **General** i **Explore**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

AIMLC dolazi sa dva ugrađena primarna agenta i dva ugrađena subagenta.
...
Ako temperatura nije navedena, AIMLC koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu AIMLC konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj AIMLC konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [AIMLC Zen](/docs/zen), koristili biste `opencode/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/harimuliawan999-sys/ai-muliawan-long-code).
:::
