---
title: TUI
description: Korištenje korisničkog interfejsa AIMLC terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AIMLC pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AIMLC pokreće TUI za trenutni direktorij.
...
Kada koristite AIMLC TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AIMLC. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AIMLC. _Aliases_: `/quit`, `/q`
