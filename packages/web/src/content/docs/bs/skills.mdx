...
Agent skills omogucavaju AIMLC da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Za projektne lokalne putanje, AIMLC ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
AIMLC navodi dostupne skills u opisu `skill` alata.
