---
title: LSP Server
description: AIMLC lässt sich in Ihren LSP-Server integrieren.
---

AIMLC lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

AIMLC verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn AIMLC eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer AIMLC-Konfiguration anpassen.
