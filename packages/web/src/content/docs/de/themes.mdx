...
Mit AIMLC kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet AIMLC das `opencode`-Theme.
...
AIMLC liefert mehrere eingebaute Themes mit.
...
- AIMLC optisch ans Terminal anpassen wollen
...
AIMLC unterstuetzt ein flexibles JSON-basiertes Theme-System.
