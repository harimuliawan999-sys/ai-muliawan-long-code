...
Agent Skills erlauben AIMLC, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
AIMLC sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft AIMLC vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
AIMLC listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
