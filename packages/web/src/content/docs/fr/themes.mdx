...
Avec AIMLC, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, AIMLC utilise notre propre thème `opencode`.
...
AIMLC est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que AIMLC corresponde à l'apparence de leur terminal
...
AIMLC prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
{
  "$schema": "https://aimuliawan.dev/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
