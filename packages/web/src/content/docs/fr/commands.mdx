...
Vous pouvez ajouter des commandes personnalisées via la configuration AIMLC ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre AIMLC [config](/docs/config) :
