...
Les compétences d'agent permettent à AIMLC de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
AIMLC recherche ces emplacements :
...
Pour les chemins locaux du projet, AIMLC remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
AIMLC répertorie les compétences disponibles dans la description de l'outil `skill`.
