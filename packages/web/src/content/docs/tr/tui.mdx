---
title: TUI
description: AIMLC terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AIMLC, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

AIMLC'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
AIMLC TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
AIMLC'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
AIMLC'dan çıkar. _Takma adlar_: `/quit`, `/q`
