...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını aimuliawan.dev'de barındırmak için kullandığımız hizmete gönderilir.
