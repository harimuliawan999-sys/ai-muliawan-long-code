...
description: AIMLC, LSP sunucularınızla bütünleşir.
---

AIMLC, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

AIMLC, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
