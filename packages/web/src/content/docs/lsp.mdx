---
title: LSP Servers
description: AIMLC integrates with your LSP servers.
---

AIMLC integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

AIMLC comes with several built-in LSP servers for popular languages:
