...
Le skill degli agenti permettono a AIMLC di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
AIMLC cerca in queste posizioni:
...
Per i percorsi locali al progetto, AIMLC risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
AIMLC elenca le skill disponibili nella descrizione dello strumento `skill`.
