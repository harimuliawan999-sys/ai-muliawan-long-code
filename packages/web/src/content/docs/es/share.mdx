---
title: Compartir
description: Comparte tus conversaciones AIMLC.
---

La función para compartir de AIMLC te permite crear enlaces públicos a tus conversaciones de AIMLC, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, AIMLC:
...
AIMLC admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, AIMLC usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
