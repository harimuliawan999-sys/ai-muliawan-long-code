...
Puede agregar comandos personalizados a través de la configuración AIMLC o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su AIMLC [config](/docs/config):
