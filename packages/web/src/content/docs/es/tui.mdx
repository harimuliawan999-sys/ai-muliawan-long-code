---
title: TUI
description: Usando la interfaz de usuario del terminal AIMLC.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AIMLC proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar AIMLC se inicia TUI para el directorio actual.
...
Cuando utilice AIMLC TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a AIMLC. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
