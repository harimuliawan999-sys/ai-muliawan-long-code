---
title: SDK
description: Typowany klient JS dla serwera AIMLC.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS AIMLC zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli AIMLC.
...
Jeśli masz już działającą instancję AIMLC, możesz utworzyć instancję klienta, aby się z nią połączyć:
...
```typescript
import type { Session, Message, Part } from "@aimuliawan/sdk"
```
