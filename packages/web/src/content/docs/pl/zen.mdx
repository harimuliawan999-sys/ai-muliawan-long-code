---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez AIMLC.
---
...
AIMLC Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół AIMLC.

:::note
AIMLC Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w AIMLC. Logujesz się do AIMLC Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z AIMLC.
:::
...
AIMLC Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

AIMLC Zen działa jak każdy inny dostawca w AIMLC.

1. Logujesz się do **<a href={console}>AIMLC Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz AIMLC Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji AIMLC używa formatu
...
- MiniMax M2.5 Free jest dostępny w AIMLC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Pro Free jest dostępny w AIMLC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w AIMLC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w AIMLC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w AIMLC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w AIMLC także dowolnego innego dostawcy.
