...
Możesz także pobrać plik binarny z [Releases](https://github.com/harimuliawan999-sys/ai-muliawan-long-code/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [AIMLC Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [aimuliawan.dev/auth](https://aimuliawan.dev/auth).
...
Oto [przykładowa rozmowa](https://aimuliawan.dev/s/4XP1fce5) z opencode.
