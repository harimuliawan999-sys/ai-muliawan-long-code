---
title: Share
description: Share your AIMLC conversations.
---

AIMLC's share feature allows you to create public links to your AIMLC conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, AIMLC:
...
AIMLC supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, AIMLC uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
