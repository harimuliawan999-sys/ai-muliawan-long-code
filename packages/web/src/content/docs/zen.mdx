---
title: Zen
description: Curated list of models provided by AIMLC.
---
...
AIMLC Zen is a list of tested and verified models provided by the AIMLC team.

:::note
AIMLC Zen is currently in beta.
:::

Zen works like any other provider in AIMLC. You login to AIMLC Zen and get
...
:::tip
We tested a select group of models and providers that work well with AIMLC.
:::
...
AIMLC Zen is an AI gateway that gives you access to these models.

---

## How it works

AIMLC Zen works like any other provider in AIMLC.

1. You sign in to **<a href={console}>AIMLC Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select AIMLC Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your AIMLC config
...
- MiniMax M2.5 Free is available on AIMLC for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on AIMLC for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on AIMLC for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with AIMLC as well.
