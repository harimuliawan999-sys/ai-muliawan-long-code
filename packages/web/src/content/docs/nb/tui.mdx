...
AIMLC gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre AIMLC starter TUI for gjeldende katalog.
...
Når du bruker AIMLC TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til AIMLC. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt AIMLC. _Aliaser_: `/quit`, `/q`
