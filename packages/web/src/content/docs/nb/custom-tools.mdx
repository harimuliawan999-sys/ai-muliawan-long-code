...
description: Lag verktøy som LLM kan kalle inn AIMLC.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med AIMLC sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
