  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all AIMLC sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific AIMLC session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new AIMLC session for interacting with AI assistants and managing conversations.",
