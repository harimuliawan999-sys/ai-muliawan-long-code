...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/harimuliawan999-sys/ai-muliawan-long-code.git")).toEqual({ owner: "sst", repo: "aimlc" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/harimuliawan999-sys/ai-muliawan-long-code")).toEqual({ owner: "sst", repo: "aimlc" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:harimuliawan999-sys/ai-muliawan-long-code.git")).toEqual({ owner: "sst", repo: "aimlc" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:harimuliawan999-sys/ai-muliawan-long-code")).toEqual({ owner: "sst", repo: "aimlc" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/harimuliawan999-sys/ai-muliawan-long-code.git")).toEqual({ owner: "sst", repo: "aimlc" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/harimuliawan999-sys/ai-muliawan-long-code")).toEqual({ owner: "sst", repo: "aimlc" })
})
