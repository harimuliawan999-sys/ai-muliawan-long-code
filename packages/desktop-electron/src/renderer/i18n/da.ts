export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AIMLC",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AIMLC er blevet downloadet. Vil du installere den og genstarte?",
