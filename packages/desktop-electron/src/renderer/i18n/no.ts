export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AIMLC",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AIMLC er lastet ned. Vil du installere den og starte på nytt?",
