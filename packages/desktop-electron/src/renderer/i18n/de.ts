export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AIMLC",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AIMLC wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
