export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'AIMLC",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'AIMLC a été téléchargée. Voulez-vous l'installer et redémarrer ?",
