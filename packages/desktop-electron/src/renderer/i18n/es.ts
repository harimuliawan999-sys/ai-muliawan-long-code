export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AIMLC",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AIMLC. ¿Quieres instalarla y reiniciar?",
