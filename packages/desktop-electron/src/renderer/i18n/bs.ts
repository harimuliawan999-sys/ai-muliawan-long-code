export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AIMLC-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AIMLC-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
