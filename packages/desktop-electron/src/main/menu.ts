...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "AIMLC Documentation", click: () => shell.openExternal("https://aimuliawan.dev/docs") },
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/harimuliawan999-sys/ai-muliawan-long-code/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/harimuliawan999-sys/ai-muliawan-long-code/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
