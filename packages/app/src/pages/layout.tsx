...
import { base64Encode } from "@aimuliawan/shared/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@aimuliawan/ui/resize-handle"
import { Button } from "@aimuliawan/ui/button"
import { IconButton } from "@aimuliawan/ui/icon-button"
import { Tooltip } from "@aimuliawan/ui/tooltip"
...
import { Session, type Message } from "@aimuliawan/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@aimuliawan/ui/toast"
...
import { retry } from "@aimuliawan/shared/util/retry"
...
import { useTheme, type ColorScheme } from "@aimuliawan/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://aimuliawan.dev/desktop-feedback")}
      renderPanel={() =>
