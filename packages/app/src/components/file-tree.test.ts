...
beforeAll(async () => {
  ...
  mock.module("@aimuliawan/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@aimuliawan/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@aimuliawan/ui/icon", () => ({ Icon: () => null }))
  mock.module("@aimuliawan/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
