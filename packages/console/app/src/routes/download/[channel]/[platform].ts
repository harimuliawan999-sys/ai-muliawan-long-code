...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "AIMLC Desktop.dmg",
  "darwin-x64-dmg": "AIMLC Desktop.dmg",
  "windows-x64-nsis": "AIMLC Desktop Installer.exe",
...
export async function GET({ params: { platform, channel } }: APIEvent) {
  ...
  const resp = await fetch(
    `https://github.com/anomalyco/${channel === "stable" ? "aimlc" : "opencode-beta"}/releases/latest/download/${assetName}`,
    {
      cf: {
