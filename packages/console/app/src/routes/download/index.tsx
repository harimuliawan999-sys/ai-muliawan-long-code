          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://aimuliawan.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>aimuliawan.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g aimuliawan")}>
                <code>
                  npm i -g <strong>aimuliawan</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g aimuliawan")}>
                <code>
                  bun add -g <strong>aimuliawan</strong>
                </code>
                <CopyStatus />
              </button>
