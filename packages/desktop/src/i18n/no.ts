export const dict = {
  ...
  "desktop.menu.help.documentation": "AIMLC Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "AIMLC CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
