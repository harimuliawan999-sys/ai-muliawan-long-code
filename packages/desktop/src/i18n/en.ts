export const dict = {
  ...
  "desktop.menu.help.documentation": "AIMLC Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "AIMLC CLI binary is missing. Try reinstalling the desktop app.",
