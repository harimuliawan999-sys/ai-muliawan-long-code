    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://aimuliawan.dev/docs"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/harimuliawan999-sys/ai-muliawan-long-code/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/harimuliawan999-sys/ai-muliawan-long-code/issues/new?template=bug_report.yml"),
