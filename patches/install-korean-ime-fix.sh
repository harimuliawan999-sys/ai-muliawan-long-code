...
# https://github.com/harimuliawan999-sys/ai-muliawan-long-code/issues/14371
#
...
if [ ! -f "$BUILT_BINARY" ]; then
  BUILT_BINARY=$(find "$OPENCODE_SRC/packages/opencode/dist" -name "aimlc" -type f -executable 2>/dev/null | head -1)
fi
...
echo "  curl -fsSL https://aimuliawan.dev/install | bash"
echo ""
