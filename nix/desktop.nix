...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/AIMLC $out/bin/opencode-desktop
    sed -i 's|^Exec=AIMLC$|Exec=opencode-desktop|' $out/share/applications/AIMLC.desktop
  '';

  meta = {
    description = "AIMLC Desktop App";
    homepage = "https://aimuliawan.dev";
