...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/harimuliawan999-sys/ai-muliawan-long-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for harimuliawan999-sys/ai-muliawan-long-code...\n")
...
console.log("Fetching npm all-time downloads for aimuliawan...\n")
const npmDownloads = await fetchNpmDownloads("aimuliawan")
